...
export function OrderDropdown({ onValueChange }: OrderDropdownProps) {
  return (
    <Select onValueChange={onValueChange}>
      <SelectTrigger className="w-[120px] bg-gray-200 text-gray-700 border-gray-300 rounded-full h-7 px-2 text-xs focus:ring-0 focus:ring-offset-0 focus:outline-black" tabIndex={0}>
