      ...
      <header className="bg-accent shadow-sm">
        <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="space-x-4">
            ...
            <Link href="/login" className="bg-primary text-background hover:bg-secondary px-4 py-2 rounded">Login</Link>
          </div>
        </nav>
      </header>
      ...
      <main className="flex-grow">
        <section className="bg-muted py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-4 text-foreground">Collaborate on Notes in Real-Time</h1>
            ...
            <div className="mt-8">
              <Link href="/notes" className="bg-accent text-foreground hover:bg-secondary px-6 py-3 rounded-lg text-lg font-semibold">
